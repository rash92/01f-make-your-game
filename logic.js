...
const generateLevel = (numEnemies, numPowerups) => {
	...
	if (currentLevel == 2) {
		walkableCells.forEach((cell) => (cell.style.backgroundColor = "teal"))
		breakableCells.forEach((cell) => (cell.style.backgroundColor = "teal"))
	}
...
const gameLoop = (timestamp) => {
	if (currentLevel == 2) {
		const bombCells = Array.from(document.querySelectorAll(".bomb"))
		bombCells.forEach((cell) => (cell.style.backgroundColor = "teal"))
	}
	walkableCells = Array.from(document.querySelectorAll(".walkable"))
